...
if(is_file('bpmanager/langs/index.php')) include 'bpmanager/langs/index.php';
elseif(is_file('langs/bpmanager/index.php')) include 'langs/bpmanager/index.php';
